...
//===================================
const MyCleanUpMessageComponent = () => <b>Cleanup completed</b>;
//===================================
...
function MyApp() {
  ...
  return (
    <div style={myContainerStyle}>
      ...
      <button type="button" onClick={myBooleanHandler} style={myButtonStyle}>
        {myBoolean ? "Unmount component" : "Mount component"}
      </button>
      <hr style={mySpacerStyle} />
      <div>
        {myBoolean ? <MyUseEffectComponent /> : <MyCleanUpMessageComponent />}
      </div>
    </div>
  );
}
